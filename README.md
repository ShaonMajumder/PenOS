...
Boot `PenOS.iso` in QEMU/VirtualBox/VMware or dd it to a BIOS-capable USB stick. The shell currently understands `help`, `clear`, `echo <text>`, `ticks`, `sysinfo`, `ps`, `spawn <counter|spinner>`, `kill <pid>`, and `halt`.

## Feature Map

| Area                   | What you get today                                                                                              | Deep-dive docs                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | Key sources                                                                      |
| ---------------------- | --------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- |
| Boot & CPU bring-up    | GRUB → `boot.s` → `kernel_main`, flat GDT/IDT, PIC remap, PIT @100 Hz                                           | [`docs/architecture.md`](docs/architecture.md#1-cpu-bring-up), [`docs/commits/feature-core/1_bootstrap.md`](docs/commits/feature-core/1_bootstrap.md)                                                                                                                                                                                                                                                                                                                                        | `src/boot.s`, `src/arch/x86/gdt.c`, `src/arch/x86/idt.c`, `src/arch/x86/timer.c` |
...
| UI + shell             | VGA text console with scrolling + cursor, blocking shell with task management commands                          | [`docs/architecture.md`](docs/architecture.md#5-ui-and-shell)                                                                                                                                                                                                                                                                                                                                                                                                                                | `src/ui/console.c`, `src/shell/shell.c`                                          |
...
- Commit deep dives:
  ...
  - docs\commits\fix-wsl-multiboot-scheduler-stability\1_fix-wsl-multiboot-scheduler-stability.md
